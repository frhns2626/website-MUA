...
@section('content')
    ...
    <div class="mb-6 md:mb-8">
        <div class="flex items-center gap-3 mb-2">
            ...
            <h1 class="text-2xl md:text-3xl font-bold text-gray-800">Tambah Kebaya Baru</h1>
        </div>
        <p class="text-sm text-gray-600 ml-9">Tambahkan kebaya baru untuk koleksi sewa kebaya Anda</p>
    </div>

    <!-- Form -->
    <div class="bg-white rounded-xl shadow-md p-6 md:p-8">
        <form action="{{ route('admin.kebayas.store') }}" method="POST" enctype="multipart/form-data" id="kebaya-form">
            @csrf
            ...
            <div class="mb-6">
                ...
                <textarea name="description" 
                          ...
                          class="block w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500 transition-colors resize-none">{{ old('description') }}</textarea>
            </div>
