...
<section id="terms" class="py-8 sm:py-12 md:py-16 lg:py-24 bg-white">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-6xl mx-auto">
            <h2 class="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-2 sm:mb-3 text-center px-2" style="font-family: 'Dancing Script', cursive;">
                Firliamakeup 2026
            </h2>
            <h3 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-3 sm:mb-4 md:mb-6 text-center px-2">PRICELIST TAMBAHAN</h3>
            <p class="text-xs sm:text-sm md:text-base text-gray-600 mb-6 sm:mb-8 md:mb-10 text-center max-w-3xl mx-auto px-4">
                PL tambahan hanya berlaku untuk paket Premium, Gold dan Luxury
            </p>

            <!-- Pricelist Tambahan -->
            <div class="bg-gradient-to-br from-pink-50 to-purple-50 rounded-lg p-4 sm:p-6 md:p-8 lg:p-10 mb-6 sm:mb-8 md:mb-10 shadow-md">
                <h4 class="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 mb-3 sm:mb-4 md:mb-6">Layanan Tambahan</h4>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 md:gap-4">
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center py-2 sm:py-2.5 border-b border-gray-200 gap-1 sm:gap-0">
                        <span class="text-xs sm:text-sm md:text-base text-gray-700 break-words pr-2">Solo Hijab & Melati</span>
                        <span class="text-xs sm:text-sm md:text-base font-semibold text-pink-600 whitespace-nowrap">Rp 600.000</span>
                    </div>
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center py-2 sm:py-2.5 border-b border-gray-200 gap-1 sm:gap-0">
                        <span class="text-xs sm:text-sm md:text-base text-gray-700 break-words pr-2">Siger Sunda Hijab & Melati</span>
                        <span class="text-xs sm:text-sm md:text-base font-semibold text-pink-600 whitespace-nowrap">Rp 400.000</span>
                    </div>
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center py-2 sm:py-2.5 border-b border-gray-200 gap-1 sm:gap-0">
                        <span class="text-xs sm:text-sm md:text-base text-gray-700 break-words pr-2">Solo / Jogja Paes only</span>
                        <span class="text-xs sm:text-sm md:text-base font-semibold text-pink-600 whitespace-nowrap">Rp 750.000</span>
                    </div>
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center py-2 sm:py-2.5 border-b border-gray-200 gap-1 sm:gap-0">
                        <span class="text-xs sm:text-sm md:text-base text-gray-700 break-words pr-2">Siger Hairdo only</span>
                        <span class="text-xs sm:text-sm md:text-base font-semibold text-pink-600 whitespace-nowrap">Rp 500.000</span>
                    </div>
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center py-2 sm:py-2.5 border-b border-gray-200 gap-1 sm:gap-0">
                        <span class="text-xs sm:text-sm md:text-base text-gray-700 break-words pr-2">Hairdo Pengantin Modern</span>
                        <span class="text-xs sm:text-sm md:text-base font-semibold text-pink-600 whitespace-nowrap">Rp 450.000</span>
                    </div>
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center py-2 sm:py-2.5 border-b border-gray-200 gap-1 sm:gap-0">
                        <span class="text-xs sm:text-sm md:text-base text-gray-700 break-words pr-2">Hairdo Dewasa</span>
                        <span class="text-xs sm:text-sm md:text-base font-semibold text-pink-600 whitespace-nowrap">Rp 250.000</span>
                    </div>
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center py-2 sm:py-2.5 border-b border-gray-200 gap-1 sm:gap-0">
                        <span class="text-xs sm:text-sm md:text-base text-gray-700 break-words pr-2">Busana Sepasang Pengantin</span>
                        <span class="text-xs sm:text-sm md:text-base font-semibold text-pink-600 whitespace-nowrap">Rp 800.000</span>
                    </div>
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center py-2 sm:py-2.5 border-b border-gray-200 gap-1 sm:gap-0">
                        <span class="text-xs sm:text-sm md:text-base text-gray-700 break-words pr-2">Set Kebaya Ibu / Jaga buku</span>
                        <span class="text-xs sm:text-sm md:text-base font-semibold text-pink-600 whitespace-nowrap">Rp 150.000</span>
                    </div>
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center py-2 sm:py-2.5 border-b border-gray-200 gap-1 sm:gap-0">
                        <span class="text-xs sm:text-sm md:text-base text-gray-700 break-words pr-2">Set Beskap / Basofi Bapak</span>
                        <span class="text-xs sm:text-sm md:text-base font-semibold text-pink-600 whitespace-nowrap">Rp 150.000</span>
                    </div>
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center py-2 sm:py-2.5 border-b border-gray-200 gap-1 sm:gap-0">
                        <span class="text-xs sm:text-sm md:text-base text-gray-700 break-words pr-2">Set Baju Pengapit</span>
                        <span class="text-xs sm:text-sm md:text-base font-semibold text-pink-600 whitespace-nowrap">Rp 100.000</span>
                    </div>
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center py-2 sm:py-2.5 border-b border-gray-200 gap-1 sm:gap-0">
                        <span class="text-xs sm:text-sm md:text-base text-gray-700 break-words pr-2">Makeup Anak</span>
                        <span class="text-xs sm:text-sm md:text-base font-semibold text-pink-600 whitespace-nowrap">Rp 100.000</span>
                    </div>
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center py-2 sm:py-2.5 border-b border-gray-200 gap-1 sm:gap-0">
                        <span class="text-xs sm:text-sm md:text-base text-gray-700 break-words pr-2">Makeup Dewasa</span>
                        <span class="text-xs sm:text-sm md:text-base font-semibold text-pink-600 whitespace-nowrap">Rp 200.000</span>
                    </div>
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center py-2 sm:py-2.5 border-b border-gray-200 gap-1 sm:gap-0">
                        <span class="text-xs sm:text-sm md:text-base text-gray-700 break-words pr-2">Pranotocoro</span>
                        <span class="text-xs sm:text-sm md:text-base font-semibold text-pink-600 whitespace-nowrap">Rp 600.000</span>
                    </div>
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center py-2 gap-1 sm:gap-0">
                        <span class="text-xs sm:text-sm md:text-base text-gray-700 break-words pr-2">Cucuk Lampah</span>
                        <span class="text-xs sm:text-sm md:text-base font-semibold text-pink-600 whitespace-nowrap">Rp 750.000</span>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
                ...
                <div class="bg-gray-50 rounded-lg p-4 sm:p-6 md:p-8">
                    <h4 class="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 mb-3 sm:mb-4 md:mb-6 flex items-center">
                        <svg class="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-pink-600 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                        <span class="break-words">Syarat & Ketentuan</span>
                    </h4>
                    <ul class="space-y-2.5 sm:space-y-3 md:space-y-4 text-xs sm:text-sm md:text-base text-gray-700">
                        <li class="flex items-start">
                            <svg class="w-4 h-4 sm:w-5 sm:h-5 text-pink-600 mr-2 sm:mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                            </svg>
                            <span class="break-words">Tidak Menerima Request Di Luar Portofolio</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-4 h-4 sm:w-5 sm:h-5 text-pink-600 mr-2 sm:mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                            </svg>
                            <span class="break-words">DP Minimal Satu Juta Rupiah</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-4 h-4 sm:w-5 sm:h-5 text-pink-600 mr-2 sm:mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                            </svg>
                            <span class="break-words">Cancel sepihak = DP Hangus 100%</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-4 h-4 sm:w-5 sm:h-5 text-pink-600 mr-2 sm:mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                            </svg>
                            <span class="break-words">Pelunasan Max. H+2 Setelah Acara</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-4 h-4 sm:w-5 sm:h-5 text-pink-600 mr-2 sm:mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                            </svg>
                            <span class="break-words">Transport Menyesuaikan Lokasi (Grabcar PP)</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-4 h-4 sm:w-5 sm:h-5 text-pink-600 mr-2 sm:mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                            </svg>
                            <span class="break-words">Wajib Menjaga Busana Dengan Baik</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-4 h-4 sm:w-5 sm:h-5 text-pink-600 mr-2 sm:mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                            </svg>
                            <span class="break-words">Bila Terjadi Kerusakan Pada Busana Maka Akan Dikenakan Denda Tergantung Keparahan</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-4 h-4 sm:w-5 sm:h-5 text-pink-600 mr-2 sm:mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                            </svg>
                            <span class="break-words">Pergantian Busana Terakhir Max. Jam 2 siang (Lebih Dari Itu Dikenakan Charge Senilai 100.000/Jam)</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-4 h-4 sm:w-5 sm:h-5 text-pink-600 mr-2 sm:mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                            </svg>
                            <span class="break-words">Jam kerja max. Sampai jam 2 siang. Lebih dari itu terkena charge 100.000/jam</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-4 h-4 sm:w-5 sm:h-5 text-pink-600 mr-2 sm:mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                            </svg>
                            <span class="break-words">Busana yg ditinggal harus dikembalikan Max. H+2</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-4 h-4 sm:w-5 sm:h-5 text-pink-600 mr-2 sm:mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                            </svg>
                            <span class="break-words">Kuota Harga Melati Solo max.500rb (jika harga melati naik maka akan dikenakan charge sesuai kenaikan harga. Krn harga melati bisa naik setiap hari nya)</span>
                        </li>
                    </ul>
                </div>

                <!-- Perhatian -->
                <div class="bg-red-50 border-2 border-red-200 rounded-lg p-4 sm:p-6 md:p-8">
                    <h4 class="text-lg sm:text-xl md:text-2xl font-bold text-red-900 mb-3 sm:mb-4 md:mb-6 flex items-center">
                        <svg class="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-red-600 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                        </svg>
                        <span class="break-words">PERHATIAN</span>
                    </h4>
                    <ul class="space-y-2.5 sm:space-y-3 md:space-y-4 text-xs sm:text-sm md:text-base text-red-800">
                        <li class="flex items-start">
                            <svg class="w-4 h-4 sm:w-5 sm:h-5 text-red-600 mr-2 sm:mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
                            </svg>
                            <span class="break-words"><strong>STOP KRIM DOKTER H-1 BULAN</strong> (KONSUL DENGAN DOKTER DULU)</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-4 h-4 sm:w-5 sm:h-5 text-red-600 mr-2 sm:mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
                            </svg>
                            <span class="break-words"><strong>JANGAN MELAKUKAN FACIAL YANG BEREFEK PEELING H-1 BULAN</strong></span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-4 h-4 sm:w-5 sm:h-5 text-red-600 mr-2 sm:mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
                            </svg>
                            <span class="break-words">TOLONG SEDIAKAN MEJA, KIPAS (jika tidak ber AC) & RUANGAN KHUSUS MAKEUP DAN GANTI BUSANA PENGANTIN</span>
                        </li>
                    </ul>
                </div>
            </div>
...
<!-- Contact Section -->
<section id="contact" class="py-8 sm:py-12 md:py-16 lg:py-24 bg-white">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto text-center">
            <h2 class="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-2 sm:mb-3 md:mb-4 px-2">
                Kontak Firliamakeup Untuk Konsultasi Jadwal & Booking
            </h2>
            <p class="text-sm sm:text-base md:text-lg text-gray-600 mb-4 sm:mb-6 md:mb-8 px-4 leading-relaxed">
            ...
            <div class="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 sm:gap-4 md:gap-6 px-4 sm:px-0">
                <a href="https://wa.me/6285236478565"
                    class="inline-flex items-center justify-center bg-green-500 text-white px-5 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-4 rounded-full text-sm sm:text-base md:text-lg font-semibold hover:bg-green-600 transition-colors shadow-lg hover:shadow-xl w-full sm:w-auto min-w-0">
                    <svg class="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <span class="truncate">0852-3647-8565</span>
                </a>
                <a href="https://www.instagram.com/firliamakeup"
                    target="_blank"
                    rel="noopener noreferrer"
                    class="inline-flex items-center justify-center bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 text-white px-5 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-4 rounded-full text-sm sm:text-base md:text-lg font-semibold hover:opacity-90 transition-opacity shadow-lg hover:shadow-xl w-full sm:w-auto min-w-0">
                    <svg class="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <span class="truncate">@firliamakeup</span>
                </a>
            </div>
        </div>
    </div>
