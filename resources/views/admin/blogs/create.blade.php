...
@section('content')
    ...
    <div class="mb-6 md:mb-8">
        <div class="flex items-center gap-3 mb-2">
            ...
            <h1 class="text-2xl md:text-3xl font-bold text-gray-800">Tambah Postingan Blog Baru</h1>
        </div>
        <p class="text-sm text-gray-600 ml-9">Buat postingan blog baru untuk berbagi informasi dan tips</p>
    </div>
        ...
        <form action="{{ route('admin.blogs.store') }}" method="POST" enctype="multipart/form-data" id="blog-form">
            ...
            <div class="mb-6">
                ...
                <textarea name="excerpt" 
                          ...
                          class="block w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none">{{ old('excerpt') }}</textarea>
                @error('excerpt')
                    <p class="mt-1 text-sm text-red-600 flex items-center">
                        <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
            ...
            <div class="mb-6">
                ...
                <textarea name="content" 
                          ...
                          class="block w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none">{{ old('content') }}</textarea>
            </div>
