...
@section('content')
    ...
    <div class="mb-6 md:mb-8">
        <div class="flex items-center gap-3 mb-2">
            ...
            <h1 class="text-2xl md:text-3xl font-bold text-gray-800">Tambah Portfolio Baru</h1>
        </div>
        <p class="text-sm text-gray-600 ml-9">Tambahkan portfolio baru untuk menampilkan karya makeup Anda</p>
    </div>

    <!-- Form -->
    <div class="bg-white rounded-xl shadow-md p-6 md:p-8">
        <form action="{{ route('admin.portfolios.store') }}" method="POST" enctype="multipart/form-data" id="portfolio-form">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500">
                        Kosongkan untuk penugasan otomatis. Angka lebih kecil muncul lebih dulu. Jika urutan sudah ada, akan disesuaikan secara otomatis.
                    </p>
                </div>
            </div>
