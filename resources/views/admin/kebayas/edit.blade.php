...
@section('content')
    ...
    <div class="mb-6 md:mb-8">
        <div class="flex items-center gap-3 mb-2">
            ...
            <h1 class="text-2xl md:text-3xl font-bold text-gray-800">Edit Kebaya</h1>
        </div>
        <p class="text-sm text-gray-600 ml-9">Edit informasi kebaya untuk koleksi sewa kebaya Anda</p>
    </div>

    <!-- Form -->
    <div class="bg-white rounded-xl shadow-md p-6 md:p-8">
        <form action="{{ route('admin.kebayas.update', $kebaya) }}" method="POST" enctype="multipart/form-data" id="kebaya-form">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                <label for="title" class="block text-sm font-semibold text-gray-700 mb-2">
                    Nama Kebaya <span class="text-red-500">*</span>
                </label>
                <div class="relative">
                    ...
                    <input type="text" 
                           name="title" 
                           id="title" 
                           value="{{ old('title', $kebaya->title) }}" 
                           required
                           placeholder="Contoh: Kebaya Modern, Kebaya Tradisional"
            ...
            <div class="mb-6">
                ...
                <textarea name="description" 
                          id="description" 
                          rows="4"
                          placeholder="Masukkan deskripsi kebaya (opsional)"
                          class="block w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500 transition-colors resize-none">{{ old('description', $kebaya->description) }}</textarea>
            </div>
            ...
            <div class="mb-6">
                <label class="flex items-center cursor-pointer">
                    <div class="relative">
                        <input type="checkbox" 
                               name="is_active" 
                               value="1" 
                               {{ old('is_active', $kebaya->is_active) ? 'checked' : '' }}
                               class="sr-only peer">
                ...
                <p class="mt-1 text-xs text-gray-500 ml-14">Kebaya aktif akan ditampilkan di website</p>
            </div>
