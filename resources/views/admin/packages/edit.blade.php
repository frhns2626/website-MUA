...
@section('content')
    ...
    <div class="mb-6 md:mb-8">
        ...
        <p class="text-sm text-gray-600 ml-9">Edit informasi paket layanan Anda</p>
    </div>
        ...
        <form action="{{ route('admin.packages.update', $package) }}" method="POST" id="package-form">
            ...
            <div class="mb-6">
                ...
                <textarea name="description" 
                          ...
                          class="block w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors resize-none">{{ old('description', $package->description) }}</textarea>
            </div>
                    ...
                    @if($package->features && count($package->features) > 0)
                        ...
                        <div class="flex gap-2">
                            ...
                            <button type="button" 
                                    ...
                                    class="bg-red-500 text-white px-4 py-2.5 rounded-lg hover:bg-red-600 transition-colors {{ $index === 0 && count($package->features) === 1 ? 'hidden' : '' }}">
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    ...
                    <input type="text" 
                           name="color_gradient" 
                           id="color_gradient" 
                           value="{{ old('color_gradient', $package->color_gradient ?? 'from-purple-500 to-purple-700') }}"
