<footer class="bg-gray-900 text-white relative">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            <!-- About Section -->
            <div>
                <h3 class="text-xl md:text-2xl font-bold text-pink-400 mb-3 md:mb-4">Firliamakeup</h3>
                <p class="text-sm md:text-base text-gray-400 mb-3 md:mb-4">
                    Professional Makeup Artist Demak. Melayani jasa makeup untuk berbagai acara penting Anda.
                </p>
                <div class="flex space-x-3 md:space-x-4">
                    ...
                    <a href="#" class="text-gray-400 hover:text-pink-400 transition-colors" aria-label="YouTube">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
                ...
                <div class="space-y-2 text-sm md:text-base text-gray-400">
                    <p class="flex items-center">
                        ...
                        <a href="https://wa.me/6285236478565" class="hover:text-pink-400">0852-3647-8565</a>
                    </p>
                    <p class="flex items-center">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="border-t border-gray-800 mt-6 md:mt-8 pt-6 md:pt-8 text-center text-gray-400 text-xs md:text-sm">
            <p>&copy; {{ date('Y') }} Firliamakeup Demak. All Rights Reserved.</p>
            <p class="mt-2">
                <a href="#" class="hover:text-pink-400 transition-colors">Privacy Policy</a> - 
                <a href="#" class="hover:text-pink-400 transition-colors">Disclaimer</a>
            </p>
            <!-- Secret login trigger - invisible area at bottom right -->
            <div id="secret-footer-trigger" class="absolute bottom-0 right-0 w-8 h-8 opacity-0 cursor-pointer" title="Secret"></div>
        </div>
    </div>
</footer>
